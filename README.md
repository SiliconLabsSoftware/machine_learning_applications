...
4. Then, download `Simplicity Sdk >= v2025.6.2`. You can obtain this from the Github repository [SiliconLabs/simplicity_sdk](https://github.com/SiliconLabs/simplicity_sdk).
