...
object AppUtil {
    ...
    fun optOutEdgeToEdge(window: Window,context: Context) {
        ...
        window.statusBarColor = ContextCompat.getColor(context,R.color.aura_bg_cream)
        window.navigationBarColor = ContextCompat.getColor(context,R.color.aura_bg_cream)
    }
}
