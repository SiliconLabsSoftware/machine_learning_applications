...
enum class GattService {
    GenericAccess(
        0x00001800, "org.bluetooth.service.generic_access",
    ...
    OtaService(
        "1d14d6ee-fd63-4fa1-bfa4-8f47b42119f0", "com.silabs.service.ota", R.string.ota_service_name,
    ...
    ThreadLightService(
        "dd1c077d-d306-4b30-846a-4f55cc35767a", "custom.type",
        GattCharacteristic.Light,
        GattCharacteristic.TriggerSource,
        GattCharacteristic.SourceAddress
    ),
    TheDMP(
        number = 0xFD63, "custom.type",
        GattCharacteristic.Light,
        GattCharacteristic.TriggerSource,
        GattCharacteristic.SourceAddress
    ),
    ConnectLightService(
        "62792313-adf2-4fc9-974d-fab9ddf2622c", "custom.type",
        GattCharacteristic.Light,
        GattCharacteristic.TriggerSource,
        GattCharacteristic.SourceAddress
    ),
    ZigbeeLightService(
        "bae55b96-7d19-458d-970c-50613d801bc9", "custom.type",
        GattCharacteristic.Light,
        GattCharacteristic.TriggerSource,
        GattCharacteristic.SourceAddress
    ),
    TheAmazonSideWalk(
        "9e8dea42-557b-4797-a890-90c5a93da1af", "custom.type",
        GattCharacteristic.Light,
        GattCharacteristic.TriggerSource,
        GattCharacteristic.SourceAddress
    ),
    ProprietaryLightService(
        "63f596e4-b583-4078-bfc3-b04225378713", "custom.type",
        GattCharacteristic.Light,
        GattCharacteristic.TriggerSource,
        GattCharacteristic.SourceAddress
    ),
    RangeTestService(
        "530aa649-17e6-4d62-9f20-9e393b177e63", "custom.type",
    ...
    BlinkyExample(
        "de8a5aac-a99b-c315-0c80-60d4cbb51224", "custom.type", R.string.blinky_service_name,
        GattCharacteristic.LedControl,
        GattCharacteristic.ReportButton
    ),
    ThroughputTestService(
        "bbb99e70-fff7-46cf-abc7-2d32c71820f2",
        "custom.type",
        R.string.throughput_test_service_name,
    ...
    ThroughputInformationService(
        ...
        "custom.type",
        R.string.throughput_information_service_name,
    ...
    PowerSource(
        "ec61a454-ed00-a5e8-b8f9-de9ec026ec51", "custom.type",
        GattCharacteristic.PowerSource
    ),
    EnvironmentalSensing(
        0x0000181a, "org.bluetooth.service.environmental_sensing",
    ...
    IndoorAirQuality(
        "efd658ae-c400-ef33-76e7-91b00019103b", "custom.type",
        GattCharacteristic.CO2Reading,
        GattCharacteristic.TVOCReading
    ),
    HallEffect(
        "f598dbc5-2f00-4ec5-9936-b3d1aa4f957f", "custom.type",
        GattCharacteristic.HallState,
        GattCharacteristic.HallFieldStrength,
        GattCharacteristic.HallControlPoint
    ),
    AmbientLight(
        "d24c4f4e-17a7-4548-852c-abf51127368b", "custom.type",
        GattCharacteristic.AmbientLightReact
    ),
    AutomationIo(
        0x00001815, "org.bluetooth.service.automation_io",
        GattCharacteristic.Digital
    ),
    UserInterface(
        "fcb89c40-c600-59f3-7dc3-5ece444a401b", "custom.type",
        GattCharacteristic.RgbLeds
    ),
    Motion(
        "a4e649f4-4be5-11e5-885d-feff819cdc9f", "custom.type",
        GattCharacteristic.Acceleration,
        GattCharacteristic.Orientation,
        GattCharacteristic.Calibration
    ),
    WifiCommissioningService(
        "0000aabb-0000-1000-8000-00805f9b34fb", "custom.type",
    ...
    EslDemoService(
        "35100001-4b1d-b16b-00b1-35018badf00d", "custom.type",
        GattCharacteristic.EslControlPoint,
        GattCharacteristic.EslTransferImage
    ),
    AiCryService(
        "a3c87500-8ed3-4bdf-8a39-a01bebede295", "custom.type",
    ...
    constructor(
        ...
        type: String,
        customNameId: Int,
        vararg availableCharacteristics: GattCharacteristic
    ) {
        number = UUID.fromString(uuid)
        this.type = type
        this.availableCharacteristics = arrayOf(*availableCharacteristics)
