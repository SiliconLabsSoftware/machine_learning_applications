...
enum class GattCharacteristic {
    ...
    DMPPoint("0000fd63-0000-1000-8000-00805f9b34fb", "custom.type"),
    AiInferenceResult("a3c87501-8ed3-4bdf-8a39-a01bebede295", "custom.type", BluetoothGattCharacteristic.FORMAT_UINT8),
    AiControl("a3c87502-8ed3-4bdf-8a39-a01bebede295", "custom.type", BluetoothGattCharacteristic.FORMAT_UINT8);
